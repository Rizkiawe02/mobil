                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <p>Rental Mobil Kami adalah Pintu penghubung antara penyedia rental dengan customer. Sebuah marketplace untuk penyedia rental dan customer untuk saling terhubung.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Jl. Perumnas 3</li>
                                    <li><i class="fa fa-mobile"></i> +62 811 1111 111</li>
                                    <li><i class="fa fa-envelope"></i> layanan@rental.com</li>
                                </ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design by <a href="" target="_blank">Rizki Adi Wicaksono</a>
